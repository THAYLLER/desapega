...
INSERT INTO /*TABLE_PREFIX*/t_preference VALUES
    ...
    ,('osclass', 'theme', 'one', 'STRING')
    ,('osclass', 'admin_language', 'pt_BR', 'STRING')
    ,('osclass', 'language', 'pt_BR', 'STRING')
    ...
    ,('osclass', 'timezone', 'America/Sao_Paulo', 'STRING')
    ...
    ,('osclass', 'selectable_parent_categories', '1', 'BOOLEAN')
