    ...
    <body>
        <div data-role="page" id="item-post">
            <div data-role="header">
                ...
                <h1><strong><?php _e('Publicar anúncio', 'osc_mobile'); ?></strong></h1>
            ...
            <div data-role="content" data-theme="c">
                <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
                    ...
                    <h3><?php _e('Informações Gerais', 'osc_mobile'); ?></h3>
                    <fieldset data-role="fieldcontain">
                        <label for="catId"><?php _e('Categoria', 'osc_mobile'); ?> *</label>
                        <?php MblItemForm::category_select(null, null, __('Selecione uma Categoria', 'osc_mobile')); ?>
                    </fieldset>
                    ...
                    <fieldset data-role="fieldcontain">
                        <label for="price"><?php _e('Preço', 'osc_mobile'); ?></label>
                    ...
                    <fieldset data-role="fieldcontain">
                        <div class="box photos">
                            <h3><?php _e('Fotos', 'osc_mobile'); ?></h3>
                            <div id="photos">
                                <div class="row">
                                    <input type="file" name="photos[]" />
                                </div>
                            </div>
                            <a href="#" onclick="addNewPhoto(); return false;"><?php _e('Adicionar nova Foto', 'osc_mobile'); ?></a>
                        </div>
                    </fieldset>
                    <hr/>
                    <?php } ?>
                    ...
                    <fieldset data-role="fieldcontain">
                        <h3><?php _e('Localização do Anúncio', 'osc_mobile'); ?></h3>
                        <fieldset data-role="fieldcontain">
                            <label for="countryId"><?php _e('País', 'osc_mobile'); ?></label>
                        ...
                        <fieldset id="field_select_region" data-role="fieldcontain" style="display:none;">
                            <label for="regionId"><?php _e('Estado', 'osc_mobile'); ?></label>
                            <a id="a_select_region" data-role="button" href="#page_list_regions"><?php _e("Selecione um estado...", 'osc_mobile'); ?></a>
                            <?php MblItemForm::region_text_hidden(); ?>
                        </fieldset>
                        <fieldset id="field_select_city" data-role="fieldcontain" style="display:none;">
                            <label class="ui-select" for="city"><?php _e('Cidade', 'osc_mobile'); ?></label>
                            <a id="a_select_city" data-role="button" href="#page_list_cities"><?php _e("Selecione uma cidade...", 'osc_mobile'); ?></a>
                            <?php MblItemForm::city_text_hidden(); ?>
                        </fieldset>
                        <fieldset id="field_select_city_area" data-role="fieldcontain" style="display:none;">
                            <label for="city"><?php _e('Bairro', 'osc_mobile'); ?></label>
                            <?php MblItemForm::city_area_text(osc_user()) ; ?>
                        </fieldset>
                        <fieldset id="field_select_address" data-role="fieldcontain" style="display:none;">
                            <label for="address"><?php _e('CEP', 'osc_mobile'); ?></label>
                    ...
                    <fieldset data-role="fieldcontain">
                        <h3><?php _e('Informações do Anunciante', 'osc_mobile'); ?></h3>
                        <fieldset data-role="fieldcontain">
                            <label for="contactName"><?php _e('Nome', 'osc_mobile'); ?></label>
                        ...
                        <fieldset data-role="fieldcontain">
                            <label for="showEmail" style="width: 250px;"><?php _e('Exibir este e-mail na página do anúncio', 'osc_mobile'); ?></label>
                    ...
                    <?php }?>    
                    <fieldset data-role="fieldcontain">
                    <button  type="submit"><?php _e('Publicar Anúncio', 'osc_mobile'); ?></button>
                    </fieldset>
                 </form>
            </div>
        </div>   
        ...
        <div data-role="page" data-theme="b" id="page_list_regions">
            <div data-theme="b" data-role="header">
                <h1><?php _e("Selecione um estado...", 'osc_mobile'); ?></h1>
            </div><!-- /header -->
        ...
        <div data-role="page" data-theme="b" id="page_list_cities">
            <div data-theme="b" data-role="header">
                <h1><?php _e("Selecione uma cidade...", 'osc_mobile'); ?></h1>
            </div><!-- /header -->
