...
<html>
    ...
    <body>
                ...
                <div data-theme="b" data-role="navbar" >
                    <ul>
                        <li>
                            ...
                            <a href="<?php echo osc_user_logout_url() ; ?>"><?php _e('Sair', 'osc_mobile') ; ?></a>
                            <?php } else {?>
                            <a href="<?php echo osc_user_login_url(); ?>"><?php _e('Login','osc_mobile')?></a>
                            <?php } ?>
                        </li>
                        <?php if( !osc_is_web_user_logged_in() ) { ?>
                        <li>
                            <?php if(osc_user_registration_enabled()) { ?>
                            <a href="<?php echo osc_register_account_url() ; ?>"><?php _e('Criar uma conta Grátis', 'osc_mobile'); ?></a>
                            <?php }; ?>
                        </li>
                        <?php } ?>
                        <li>
                            <a data-icon="" href="<?php echo osc_item_post_url_in_category() ; ?>"><?php _e("Publicar anúncio", 'osc_mobile');?></a>
                        </li>
                    </ul>
                </div>
        ...
        <div data-theme="c" data-role="dialog" id="search_form" data-title="<?php _e('Pesquisar','osc_mobile');?>">
            <div data-role="header">
                <h1><?php echo osc_page_title() ; ?></h1>
            </div>
